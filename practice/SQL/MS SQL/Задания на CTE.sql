...
SELECT AVG(order_count*1.0) среднее_число, MAX(order_count) максимальное_число
...
/*
Вывести наименование товара, его цену, год выпуска 
и остаток на складе для 
товаров, которых на складе осталось в 2 раза меньше, 
чем средний остаток товаров по трем брендам, для которых 
